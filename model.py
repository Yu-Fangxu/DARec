...
class DArec(nn.Module):
    def __init__(self, args):
        ...
        self.S_autorec = AutoRec(self.n_users, self.S_n_items, self.n_factors)
        self.T_autorec = AutoRec(self.n_users, self.T_n_items, self.n_factors)
        # 加载预训练
        ...
        self.DC = nn.Sequential(
            ...
            nn.Sigmoid(),
            nn.Linear(self.RPE_hidden_size // 2, self.RPE_hidden_size // 4),
            nn.Sigmoid(),
