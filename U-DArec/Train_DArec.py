...
parser.add_argument("--S_pretrained_weights", type=str, default=r'D:\DARec\Pretrained_ParametersS_AutoRec_20.pkl')
parser.add_argument("--T_pretrained_weights", type=str, default=r'D:\DARec\Pretrained_ParametersT_AutoRec_20.pkl')
args = parser.parse_args()

### Load Data
train_dataset = Mydata(r'D:\DARec\Dataset\ratings_Office_Products.csv', r'D:\DARec\Dataset\ratings_Movies_and_TV.csv', train=True, preprocessed=True)
test_dataset = Mydata(r'D:\DARec\Dataset\ratings_Office_Products.csv', r'D:\DARec\Dataset\ratings_Movies_and_TV.csv', train=False, preprocessed=True)
